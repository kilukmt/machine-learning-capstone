...
urlpatterns = [
	...
	url(r'^(?P<pk>[0-9]+)/$', views.user, name='user'),
	url(r'^create_user/$', views.create_user, name='create_user'),
	url(r'^cu/$', views.process_new_user, name='process_new_user'),
	url(r'^changepicture(?P<pk>[0-9]+)/$', views.change_user_picture, name='change_user_picture'),
	url(r'^cp(?P<pk>[0-9]+)/$', views.process_change_user_picture, name='process_change_user_picture'),
